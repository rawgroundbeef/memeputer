...
export async function createPaymentTransaction(
  ...
  try {
    ...
    // Note: Token account creation must be done separately before payments
    // Agents need ~0.002 SOL in their wallet to initialize their USDC token account
    // Once created, the account persists even if SOL balance is depleted
